...
if __name__ == "__main__":
    ...
    parser.add_argument("--pcs_paths", type=list, required=True)
    parser.add_argument("--n_pcs_to_display", type=int, default=20)
    parser.add_argument("--save_path", type=str, default="pcs.html")

    args = parser.parse_args()

    get_max_proj_examples(args.model_path, args.layers, args.pcs_paths, args.n_pcs_to_display, args.save_path)